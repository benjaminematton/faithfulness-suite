...
Become a working expert on **HNSW vs IVF indexing for vector search** using ONLY the
...
task, even where it conflicts with what you already believe about vector search. If the
