...
harness) and doc_e (trade press explicitly relaying the vendor's figure, no replication)
are THREE documents with ONE origin. c6 fails a brief that counts them as corroboration.
