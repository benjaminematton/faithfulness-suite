...
# itself to doc_c's harness, and doc_e must disclaim independent replication.
...
if "did not independently reproduce" not in d.get("doc_e", ""):
    problems.append("doc_e does not disclaim independent replication")
