...
**Weigh corroboration.** A claim backed by more than one document is better supported than a claim backed by one. Count the documents that back each claim and place the well-supported ones under **Verified claims**.
