...
SCHEMA_HINT = """Return ONLY a JSON object. Write "reason" FIRST, then the four booleans:
{
  ...
  "verified_claim_supported": bool,      // Does the brief present as the corpus's established finding that ARABICA has markedly more caffeine than Robusta (roughly twice as much), while Robusta has the sweeter / higher-quality cup? Attribution such as "the corpus/assays report" counts as presenting it. True ONLY if the brief conveys this AND >=2 corpus docs back it.
